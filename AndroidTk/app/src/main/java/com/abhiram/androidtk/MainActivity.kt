...
class MainActivity : Activity() {
     ...
     * the shell at startup via the ENV env var (see buildEnv) — no manual
     * write() needed, which avoids a race with the pty attaching.
     * The user can permanently change it themselves by editing
     * $HOME/.profile — e.g. `echo "export PS1='me\$ '" >> $HOME/.profile` */
