...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Catch any crash on any thread, write it to a file, and let the
        // process die normally — but on the NEXT launch we check for that
        // file first and show it instead of running the app. This is our
        // logcat replacement since there's no adb/computer available.
        ...
        Thread.setDefaultUncaughtExceptionHandler { thread, throwable ->
            try {
                ...
                // if we can't even write the crash file, fall through
            }
    ...
    /** Plain TextView in a ScrollView — no layout file needed, so this
     * always works even if the crash was in setContentView itself. */
